...
/**
 * @typedef {Object} MzkyzakApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} MzkyzakApiProviderShape
 * @property {string} baseURL
 * @property {MzkyzakApiAuthShape} [auth]
...
/**
 * @typedef {Object} MzkyzakApiRequestOptions
...
/**
 * @typedef {Object} MzkyzakApiMultipartFile
 ...
 */
class MzkyzakApiProvider {
  /**
   * @param {MzkyzakApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {MzkyzakApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {MzkyzakApiMultipartFile[]|Object<string, any>} [files]
   * @param {MzkyzakApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends MzkyzakApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends MzkyzakApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends MzkyzakApiProvider {
...
class ApiFaaProvider extends MzkyzakApiProvider {
...
class MzkyzakMainApiProvider extends MzkyzakApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends MzkyzakApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends MzkyzakApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends MzkyzakApiProvider {
...
class AzbryApiProvider extends MzkyzakApiProvider {
...
class YuulabsApiProvider extends MzkyzakApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends MzkyzakApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends MzkyzakApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal Mzkyzak.
 */
class MzkyzakApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @returns {MzkyzakApiProviderShape}
   */
  ...
  /**
   * @param {string} name
   * @param {MzkyzakApiProviderShape} cfg
   * @returns {MzkyzakApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<MzkyzakApiProviderShape>} cfg
   * @returns {MzkyzakApiProvider}
   */
  ...
  makeProviderClasses() {
    return {
      ...
      mzkyzak: MzkyzakMainApiProvider,
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || MzkyzakApiProvider;
  ...
  makeProviders() {
    return {
      ...
      mzkyzak: {
        baseURL: "https://api.mzkyzak.my.id",
      },
    };
  }
...
const mzkyzakApi = new MzkyzakApiManager();

export { MzkyzakApiManager, MzkyzakApiProvider, mzkyzakApi };
export default mzkyzakApi;
