...
import { logger } from "./mzkyzak-logger.js";
import { CronJob } from "cron";
import config from "../../config.js";
import * as timeHelper from "./mzkyzak-time.js";
import { saluranCtx } from "./mzkyzak-context.js";
import { getTodaySchedule, extractPrayerTimes } from "./mzkyzak-sholat-api.js";
...
async function sendSholatNotifications(sholat, waktu) {
  try {
    ...
    for (const groupId of groupList) {
      ...
      if (gcPrivateAll && !publicGroups.includes(groupId)) continue;
      if (selfGroups.includes(groupId) && !publicGroups.includes(groupId)) continue;
