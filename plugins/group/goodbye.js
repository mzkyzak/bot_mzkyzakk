import {
  ...
  isLidConverted,
  lidToJid,
} from "../../src/lib/mzkyzak-lid.js";
import moment from "moment-timezone";
import config from "../../config.js";
import { getDatabase } from "../../src/lib/mzkyzak-database.js";
import { saluranCtx } from "../../src/lib/mzkyzak-context.js";
import { createGoodbyeCard } from "../../src/lib/mzkyzak-welcome-card.js";
import { resolveAnyLidToJid } from "../../src/lib/mzkyzak-lid.js";
...
function resolvePlaceholders(
  ...
  return template
    ...
    .replace(/{bot}/gi, config.bot?.name || "Mzkyzak")
...
async function sendGoodbyeMessage(sock, groupJid, participant, groupMeta) {
  try {
    ...
    if (goodbyeType === 2) {
      ...
      await sock.sendMessage(groupJid, {
        video: getAssetBuffer("mzkyzak-mp4") || { url: "https://files.catbox.moe/k28dhp.mp4" },
        gifPlayback: true,
        caption: text,
        contextInfo: {
          mentionedJid: [realParticipant],
        ...
        viewOnceMessage: {
          message: {
            ...
            interactiveMessage: {
              ...
              footer: {
                text: config.bot?.name || "Mzkyzak-AI"
              },
              contextInfo: {
                mentionedJid: [realParticipant],
                isForwarded: true,
