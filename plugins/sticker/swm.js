...
import { addExifToWebp, isAnimatedWebp, DEFAULT_METADATA } from '../../src/lib/mzkyzak-exif.js'
...
async function handler(m, { sock, config: botConfig }) {
    ...
    if (!quoted) {
        return m.reply(
            ...
            `*ᴄᴏɴᴛᴏʜ:*\n` +
            `> \`${m.prefix}swm Mzkyzak-AI\`\n` +
            `> \`${m.prefix}swm Mzkyzak-AI|LuckyArchz\` _(packname + author)_`
        )
    }
    ...
    if (!input) {
        return m.reply(
            ...
            `*ᴄᴏɴᴛᴏʜ:*\n` +
            `> \`${m.prefix}swm Mzkyzak-AI\`\n` +
            `> \`${m.prefix}swm Mzkyzak-AI|LuckyArchz\` _(+ author)_`
        )
    }
