...
try {
  ...
  if (fs.existsSync(path.join(assetsPath, "mzkyzak-games.jpg"))) {
    thumbWW = fs.readFileSync(path.join(assetsPath, "mzkyzak-games.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "mzkyzak.jpg"))) {
    thumbNight = fs.readFileSync(path.join(assetsPath, "mzkyzak.jpg"));
    thumbDay = fs.readFileSync(path.join(assetsPath, "mzkyzak.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "mzkyzak-winner.jpg"))) {
    thumbWin = fs.readFileSync(path.join(assetsPath, "mzkyzak-winner.jpg"));
  }
} catch (e) {
