...
import fs from 'fs'
import { AIRich } from '../../src/lib/mzkyzak-builder.js'
const pluginConfig = {
    name: 'tqto',
...
async function handler(m, { sock }) {
    ...
    const credits = [
        ...
        { name: 'Zann', role: 'Creator Mzkyzak MD dan APK Stardem Mzkyzak', icon: '👨‍💻' },
        { name: 'SenzOkkotsu', role: 'Developer', icon: '👨‍💻' },
        { name: 'Ell', role: 'Developer', icon: '👨‍💻' },
        { name: 'Aqell', role: 'Developer SC BUG Mzkyzak Glitch', icon: '👨‍💻' },
