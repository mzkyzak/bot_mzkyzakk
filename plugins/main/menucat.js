...
import { getCasesByCategory } from "../../case/mzkyzak.js";
import { prepareWAMessageMedia, generateWAMessageFromContent } from "mzkyzak";
...
import { getTimeGreeting } from "../../src/lib/mzkyzak-formatter.js";
import fs from "fs"
      ...
      switch (menucatVariant) {
        ...
        case 2: {
          const media = await prepareWAMessageMedia(
            {
              image: fs.readFileSync(config.assets["mzkyzak2"]),
            },
