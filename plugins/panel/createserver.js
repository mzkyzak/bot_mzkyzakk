...
import { prepareWAMessageMedia, generateWAMessageFromContent, proto } from "mzkyzak";
import axios from 'axios'
import crypto from 'crypto'
import config from '../../config.js'
import { isLid, lidToJid } from '../../src/lib/mzkyzak-lid.js'
import { checkPanelJeda, setPanelLastUsed } from '../../src/lib/mzkyzak-panel-jeda.js'
import { hasAccessToServer, getUserRole, VALID_SERVERS } from '../../src/lib/mzkyzak-roles-cpanel.js'
...
async function handler(m, { sock }) {
  ...
  const email = `${username}@mzkyzak.md`;
  ...
  try {
    ...
    const headerMedia = await prepareWAMessageMedia(
      { image: getAssetBuffer("mzkyzak-v8") },
