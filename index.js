...
import { loadPlugins, pluginStore } from "./src/lib/mzkyzak-plugins.js";
import { initDatabase, getDatabase } from "./src/lib/mzkyzak-database.js";
import {
  initScheduler,
  loadScheduledMessages,
  startGroupScheduleChecker,
  startSewaChecker,
} from "./src/lib/mzkyzak-scheduler.js";
import { handleAntiTagSW } from "./src/lib/mzkyzak-group-protection.js";
import { initSholatScheduler } from "./src/lib/mzkyzak-sholat-scheduler.js";
import { initNotifScheduler } from "./src/lib/mzkyzak-notif-scheduler.js";
import { initAutoJpmScheduler } from "./src/lib/mzkyzak-auto-jpm.js";
import { startMemoryMonitor } from "./src/lib/mzkyzak-memory-monitor.js";
import { startTempCleaner } from "./src/lib/mzkyzak-temp-cleaner.js";
import { startDailyPruner } from "./src/lib/mzkyzak-data-pruner.js";
import { preloadAssets } from "./src/lib/mzkyzak-asset-manager.js";
import {
  logger,
  c,
  playBootSequence,
  ...
  logErrorBox,
  divider,
} from "./src/lib/mzkyzak-logger.js";

await import("./src/lib/mzkyzak-agent.js")
    ...
    (eventType, filename) => {
      ...
      const timeout = setTimeout(async () => {
        ...
        if (!fs.existsSync(fullPath)) {
          ...
          const { unloadPlugin } = await import("./src/lib/mzkyzak-plugins.js");
        ...
        try {
          ...
          const { hotReloadPlugin } =
            await import("./src/lib/mzkyzak-plugins.js");
...
async function main() {
  ...
  if (savedMode && (savedMode === "self" || savedMode === "public" || savedMode === "gc" || savedMode === "private" || savedMode === "all"))
      ...
      if (update.connection === "open") {
        ...
        try {
          const { startOtpPoller: _startOtp } =
            await import("./src/lib/mzkyzak-otp-poller.js");
          _startOtp(sock);
        } catch { }

        try {
          const { getAllJadibotSessions, restartJadibotSession } =
            await import("./src/lib/mzkyzak-jadibot-manager.js");
