...
import * as ownerPremiumDb from "./src/lib/mzkyzak-premium-db.js";
...
const config = {
  ...
  owner: {
    ...
    number: ["6285810192529"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "6285810192529", // Nomor WA yang akan di-pair, ini penting
    usePairingCode: true, // true = Pairing Code, false = QR Code
  },

  bot: {
    name: "mzkyzak BOT", // Nama bot
    version: "10,0", // Versi bot
    developer: 'mzkyzak', // Nama developer
  },

  assets: {
    "mzkyzak-daftar": "./assets/image/mzkyzak-daftar.png",
    "mzkyzak-demote": "./assets/image/mzkyzak-demote.png",
    "mzkyzak-fishit": "./assets/image/mzkyzak-fishit.jpg",
    "mzkyzak-games": "./assets/image/mzkyzak-games.jpg",
    "mzkyzak-landscape": "./assets/image/mzkyzak-landscape.jpg",
    "mzkyzak-levelup": "./assets/image/mzkyzak-levelup.jpg",
    "mzkyzak-minecraft": "./assets/image/mzkyzak-minecraft.jpg",
    "mzkyzak-promote": "./assets/image/mzkyzak-promote.png",
    "mzkyzak-rpg": "./assets/image/mzkyzak-rpg.jpg",
    "mzkyzak-rules": "./assets/image/mzkyzak-rules.jpg",
    "mzkyzak-store": "./assets/image/mzkyzak-store.png",
    "mzkyzak-v8": "./assets/image/mzkyzak-v8.jpg",
    "mzkyzak-winner": "./assets/image/mzkyzak-winner.jpg",
    "mzkyzak": "./assets/image/mzkyzak.png",
    "mzkyzak2": "./assets/image/mzkyzak2.jpg",
    "mzkyzak3": "./assets/image/mzkyzak3.jpg",
    "pp-kosong": "./assets/image/pp-kosong.jpg",
    "mzkyzak-mp4": "./assets/video/mzkyzak-mp4.mp4",
    "mzkyzak-mp3": "./assets/audio/mzkyzak-mp3.mp3",
    "mzkyzak-font": "./assets/mzkyzak-font.ttf",
    "mzkyzak-kertas": "./assets/image/mzkyzak-kertas.jpg",
  ...
  sticker: {
    packname: "mzkyzak", // Nama pack sticker
    author: "mzkyzak_bott ", // Author sticker
  },
...
- Jangan mengaku sebagai AI atau bot.`,
  ...
  APIkey: {
    ...
    lolhuman: "APIKey-Milik-Bot-MzkyzakMD(Zann,HyuuSATANN,Keisya,Danzz)",
    // kalian bisa daftar di https://api.neoxr.eu, lalu ambil apikeynya
    neoxr: "Milik-Bot-MzkyzakMD",
